...
├🚨 **Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ** : <a href=https://t.me/AKMovieBotz>AKMovieBotz</a>
├🥏 **Cʜᴀɴɴᴇʟ** : <a href=https://t.me/Cineoriginals>Cineoriginals</a>
├👨‍💻 **Cʀᴇᴀᴛᴇʀ** :  @AKMovieBotz
╰───────────────⍟
"""
...
"""
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Join : @AKMovieBotz\n For the list of Telegram bots. "
